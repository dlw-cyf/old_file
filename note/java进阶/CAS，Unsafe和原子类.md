...
![](.\assets\java-thread-x-atomicinteger-unsafe.png)
...
又从Unsafe类中发现，原子操作其实只支持下面三个方法：**compareAndSwapObject、compareAndSwapInt和compareAndSwapLong。都是native方法**
