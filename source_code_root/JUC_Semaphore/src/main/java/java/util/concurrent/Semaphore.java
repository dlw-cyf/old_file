...
public class Semaphore implements java.io.Serializable {
    ...
    static final class FairSync extends Sync {
        ...
        protected int tryAcquireShared(int acquires) {
            for (;;) {
                /**
                 * 判断当前AQS阻塞队列内是否有等待着线程，
                 * 如果有直接返回-1，表示当前aquire操作的线程需要进入到队列中等待
                 */
                ...
                /**
                 * 执行到这里，有哪几种情况？
                 * 1.调用aquire时，AQS阻塞队列内没有其他等待着节点
                 * 2.当前节点在阻塞队列内时head.next节点。
                 * */
                int available = getState();
                int remaining = available - acquires;
                /**
        ...
        public final void acquireSharedInterruptibly(int arg)
            ...
            /**
             * 尝试获取通行证，获取成功：返回大于等于0的值。获取失败返回小于0的值。
             * */
        ...
        private void doAcquireSharedInterruptibly(int arg)
            ...
            /**将调用Semaphore.aquire方法的线程，封装成Node加入AQS的阻塞队列中*/
        ...
        public final boolean releaseShared(int arg) {
            /**
             * 条件成立：表示当前线程是否资源成功，是否资源成功后，去唤醒获取资源失败的线程...
             * */
        ...
        /**
         * AQS中的方法
         * CountDownLatch版本：都有哪几种情况会调用到doReleaseShared()方法呢？
         ...
         *
         * Semaphore版本：都有哪几种情况会调用到doReleaseShared()方法呢？
         * 1.
         */
